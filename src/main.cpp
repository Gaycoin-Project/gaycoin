...
uint256 hashGenesisBlock("0x000000003a437304c092e6bb69c6c18c620ef0239deedab72b695767451a7948");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000003a437304c092e6bb69c6c18c620ef0239deedab72b695767451a7948");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Mtgox BTCUSD 2014-02-12T14:06:09; last:534.80 buy:534.80 sell:534.89";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392214016;
        block.nBits    = 486604799;
        block.nNonce   = 2665627409;
        ...
        assert(block.hashMerkleRoot == uint256("0x9812acad61696744f4680404bf96793e521c1bdea8173be56efbb5c292629d28"));
        block.print();
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running GaycoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("GaycoinMiner terminated\n");
        throw;
    }
}
